          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-base md:text-lg leading-relaxed text-slate-600">
                <p>
                  Nascida em Cachoeiro de Itapemirim e criada em Jerônimo Monteiro, sou estudante de Psicologia na UFES e tenho 21 anos.
                </p>
                <p>
              ...
              <div className="pt-6">
                <a
                  href="https://www.instagram.com/giovannadepollo"
                  target="_blank"
